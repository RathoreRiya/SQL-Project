--Q.1: Who is the semoir most employee based on job title ?
...
/*Q.4: Which city has the best customer? we would like to throw a promotional music festival in the city we made the most money.
write a query that returns one city that has a highest sum of invoices total. return both the city name and sum of all invoices totals*/
...
--another way to do this same question
...
/*Q.11: Q3: Write a query that determines the customer that has spent the most
